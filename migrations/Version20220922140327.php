 ...
 */
final class Version20220922140327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_659DF2AA1ADED311 ON chat (discussion_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_659DF2AA1ADED311 ON chat');
        $this->addSql('ALTER TABLE discussion ADD user_id INT NOT NULL');
    }
}
